ALTER TABLE magic_auth_tokens ADD COLUMN resource_type TEXT NOT NULL DEFAULT 'stardata.runtime.v1.Explore';
...
UPDATE bookmarks SET resource_kind = 'stardata.runtime.v1.Explore' WHERE resource_kind = 'stardata.runtime.v1.MetricsView';
