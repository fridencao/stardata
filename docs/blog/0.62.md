...
# StarData 0.62 - Quick project sharing and controlling your models
...
You can now quickly invite new users or add existing ones to a project directly from the StarData Cloud project view.  
