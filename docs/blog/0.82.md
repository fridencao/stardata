...
# StarData 0.82 - AI Feedback, AI in Canvas, New Status page and Scatter Plot
...
You can now give thumbs up and thumbs down to score your conversations with StarData's AI agent. This helps it learn and provide even better and more crisp answers for you and your colleagues in future chats.
...
We have massively overhauled the status page for projects within StarData Cloud. You can now easily search, filter, and find resources—for example, those that are erroring—as well as get full access to logs without having to use the CLI.
...
We're proud to introduce the ability to export data from StarData on a continuous basis. You can now set up scheduled exports of models to object storage such as S3 and GCS, exporting models from StarData as parquet files for downstream processing.
...
### StarData Developer
- Root cause errors are now surfaced in StarData Developer
- Hidden share conversation button in StarData Developer
...
- Fixed StarData logo display when forced to dark mode
