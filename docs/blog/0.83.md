...
# StarData 0.83 - Canvas Generation, Supabase Connector, Project Table Information
...
We've added a new Supabase connector, making it easy to connect to your Supabase database and bring that data into StarData.

## Project Status Tables Page

The project status page now includes a dedicated Tables tab, giving you visibility into the tables in your OLAP database directly from the StarData Cloud UI.
...
- `stardata init` now prompts for template if not provided
