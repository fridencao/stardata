...
# StarData 0.36 - Hot reloading, scheduling and DuckDB 0.9! 🔥
...
Last, but not least, this version upgrades StarData to the new version of DuckDB, v0.9.1. Head over to the [DuckDB blog](https://duckdb.org/2023/09/26/announcing-duckdb-090.html) for more details about all its new features.
