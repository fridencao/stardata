...
# StarData 0.34 - Compare Data by Any Dimension, Explore Like a Legend! 📊
...
StarData excels at providing visual data comparison by time dimensions.
...
- 🌟 **Nested Data Support** - The Bigquery connector in StarData now supports directly ingesting nested data types. 
