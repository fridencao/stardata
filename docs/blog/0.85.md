...
# StarData 0.85 - Snowflake Live Connector, First Mile Flow, Preview Mode
...
You can now create metrics views directly on Snowflake via the new live connector, expanding StarData's OLAP support beyond ClickHouse and DuckDB.

## Improved First Mile Experience

The onboarding experience has been improved to make getting started with StarData smoother and more guided.

## Preview Mode for StarData Developer
...
- Nicer hints and errors in `stardata query`
