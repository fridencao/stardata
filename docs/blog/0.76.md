...
# StarData 0.76 - Custom User Attributes and API Documentation
...
This is especially helpful when embedding StarData—now you can consolidate access rules for both external and internal users in one place.

## API Access and Documentation

We’ve added comprehensive documentation and guides for accessing the StarData API and integrating with other systems.  
Check out [our guides](/developers/tutorials/integrating-with-stardata) to get started, or explore the full [API reference documentation](/api/admin).
