...
# StarData 0.58 - Canvas dashboards
...
We’re proud to introduce the beta version of a brand-new dashboard type in StarData — Canvas dashboards!
...
- Improved testing of StarData components resulting in improved stabillity.
