...
# StarData 0.48 - New Filter bar, 🚀 Deploy from StarData Developer and Pivot from Timeseries
...
## Deploy from StarData Developer
It's now even easier to get started with StarData, you can now deploy your projects directly to StarData Cloud from within StarData Developer!
...
- Added login / signup in StarData Developer!
- Added support for self-hosting local StarData Developer using `--allowed-origins` flag on `start`.
...
- Improved logging for alerts and reports in StarData Cloud.
...
- Improved handling of errors for deploying to StarData Cloud via the UI.
- Improved user experience around redeploy to StarData Cloud via the UI.
