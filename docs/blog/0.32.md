...
# StarData 0.32 -  Level Up Your Data Exploration 📈
...
Export big data at warp speed! StarData now uses DuckDB’s `COPY TO` statement to execute CSV and Parquet data exports.
...
- **Easy Dashboard Discovery** - Finding your dashboards on StarData Cloud just got way simpler. The new homepage highlights your dashboards front and center.
...
- **Seamless Data Refresh** - Say goodbye to dashboard downtime during data refresh. StarData Cloud now updates your data seamlessly behind-the-scenes so your dashboards are always available.

With an array of upgrades both big and small, StarData 0.32 takes your data exploration to the next level. Try it out and let us know what you think!
