...
# StarData 0.78 - Default Filters for Canvas, Dynamic Markdown, Pivot Display Limits, Query Attributes
...
If you're using ClickHouse, you can now append query attributes that access dynamic user attributes. This is super useful if you want to send along, for example, a user ID or email to route or filter views in ClickHouse based on StarData user context. Or if you want to build your own usage reporting based on queries issued to your ClickHouse instance.
