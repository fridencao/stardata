...
# StarData 0.39 - Vacations, spending time away from keyboard and new ways of filtering
...
As we are adding more and more areas to StarData the need to be able to quickly add a new filter without having to go back to the Explore overview became apparent and... now you can!
  
## Auto-suggestion of models
StarData Developer will now auto-suggest model names as part of our auto-completion when writing SQL.  
...
- Added support to resize the _Model Data_ dashboard component / view in the StarData Developer UI.
