...
# StarData 0.69 – Measure Annotations, Funnel Charts and Theming in Canvas dashboards!
...
- Time Features
  - New StarData syntax in QA behind feature flag.
...
- Fixed alert when StarData time syntax `P7D` is used.
