...
# StarData 0.73 - Project AI Agent
...
## Introducing AI Agents for StarData

We've been working hard over the last couple of months to bring an agentic AI workflow to StarData. Building on our existing MCP (Model Context Protocol) server integration, we're now introducing project-wide chat in StarData, which is our first interactive agent of many to come.
...
### StarData Time Fixes and Improvements

- **Added offset stardata time syntax** - Support for time offset operations in queries
