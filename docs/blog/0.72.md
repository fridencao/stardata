...
# StarData 0.72 – We reinvented Time
...
- **StarData-time frontend parser improvements**: Enhanced time parsing capabilities
...
- **Project refresh enhancements**: Added `--connector` option to stardata project refresh
