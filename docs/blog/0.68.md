...
# StarData 0.68 – Edit exported data columns in Reports, Time pills in Pivot, Schedule Alerts and Custom Sort Order in Canvas!
...
- When no data is added to StarData Developer, show dashboard with explicit message: "Requires a metrics view".
- ClickHouse:
