...
# StarData 0.80 - AI Developer Agent, Alternate Time Dimensions and Dark Mode 
...
We are proud to introduce the AI Developer Agent into StarData Developer. The AI agent is your developer assistant, helping you model data, create and edit StarData project files, and build StarData projects. Give it a try and let us know your experiences! We are continually evolving the feature, so expect more great things to come!
...
We are now introducing dark mode to the entire product! Switch between light and dark mode from your profile, upload a dark mode variant of your logo and use custom themes prepared for dark mode! Oh, if you are embedding StarData you also have the ability to toggle dark mode as part of the Embed API.
