...
# StarData 0.59 - Re-ordering of timeseries and leaderboards and new dashboard properties!
...
In subsequent releases of StarData, we will also remember your choices so you don't have to re-order them on every visit.
...
- Fixed various bugs, UX improvements, and new features around Canvas dashboards:
  ...
  - Updated URL paths
  - Removed components from StarData Cloud's Status page
  - Image alignment
  - Flat table
...
- Always show OLAP engine option in StarData Developer
...
- Fixed issue in StarData Developer where model references were not tracked properly
