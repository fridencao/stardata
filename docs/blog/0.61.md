...
# StarData 0.61 - Pie, Donut, and Heatmap Charts and remembering where you last were! 👀
...
We’ve updated how deployed StarData dashboards load in StarData Cloud. Dashboards will now prioritize restoring the state you last used, while still respecting developer-defined configurations.
...
- Re-validate metrics view on external tables on `stardata project refresh`.
