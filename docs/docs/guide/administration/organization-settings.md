---
title: "Managing Organizations in StarData Cloud"
description: Basic management for organizations
sidebar_label: "Organization Settings"
sidebar_position: 00
---

Before a project can be deployed onto StarData Cloud, an organization must be created. If you are deploying via the UI, this will automatically be done for you. As an administrator, you can also create, edit, and delete organizations from the CLI. From the organization page, you will be able to view your projects, users, and overall settings.

## Organization

![StarData Org](/img/manage/project-management/rill-org.png)


An organization in StarData is the parent management object and encompasses how your team interfaces with StarData Cloud. Organizations are designed to hold the different components of your StarData project. Organizations consist of projects that each have their own sources, models, metrics views, dashboards, user management, and general settings.
...
### Org Settings via StarData Cloud
...
![StarData Org Settings](/img/manage/project-management/rill-org-settings.png)
