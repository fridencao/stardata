...
StarData includes AI capabilities across both development and data exploration.
...
**[AI Chat](/guide/ai/ai-chat)** is built directly into StarData Cloud, allowing you to:
...
The **[StarData MCP Server](/guide/ai/mcp)** connects your StarData projects to external AI assistants like Claude Desktop using the Model Context Protocol. This enables you to:
- Query your StarData data from Claude Desktop or other MCP-compatible tools
