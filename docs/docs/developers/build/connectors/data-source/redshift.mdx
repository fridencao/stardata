...
To connect to Amazon Redshift, you need to provide authentication credentials. StarData supports two methods:
...
Access Key and Secret Key credentials provide the most reliable authentication for Redshift. This method works for both local development and StarData Cloud deployments.
...
:::info What happens when StarData is reading from Redshift Serverless?
...
:::info What happens when StarData is reading from a Redshift Cluster?
