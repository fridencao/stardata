...
Snowflake has issued a [deprecation notice](https://www.snowflake.com/en/blog/blocking-single-factor-password-authentification/) for single-factor password authentication. StarData supports and recommends using private key authentication to avoid any disruption of your service.
...
To connect to Snowflake, you need to provide authentication credentials. StarData supports two methods:
...
Keypair authentication provides enhanced security and is the recommended method for connecting to Snowflake. This method works for both local development and StarData Cloud deployments.
...
Please refer to the [Snowflake documentation](https://docs.snowflake.com/en/guide/key-pair-auth) on how to configure an unencrypted private key to use in StarData.
