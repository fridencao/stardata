...
`time_range_start` and `time_range_end` resolve a StarData time expression against the metrics view's watermark and time range. They must be compared against the time dimension:
